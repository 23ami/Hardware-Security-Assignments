...
for iteration in range(2):
                myfile = r"C:\Users\tejas\Desktop\Hardware_Security_of_IOT\assignment3\DOM\HW_power_trace_8.csv"
                ...
                for kb in range(256):
                    ...
                    with open(myfile) as csv_file:
                        ...
                        for row in csv_reader:
                            ct = int(row[1], 10)
                            # print hex(ct)
                            ct_temp = ct >> (120-40+iteration*8)& 0xFF
                            # print hex(ct_temp)
                ...
                print(5-iteration,"th correct_key_byte=" + str(correct_key))
